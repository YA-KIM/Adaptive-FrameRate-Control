...
class Agent():
    def __init__(self, alpha=0.2, nu=3.0, threshold=0.5, num_episodes = None, load=False, n_actions=4, device =None):
        # basic settings
        self.n_actions = n_actions               # total number of actions : len([5, 10, 15, 30])=4
        self.history_length= 8                   # Numver of Windowing #Check Point
        self.Version='MOT_Ver5'                      # "Ver_#로 학습하고고
        self.Load_Ver='MOT_Ver2'                     # 학습시킨 Ver로 테스트, 따라서 load를 해야함.
        ...
        self.Frame_Rates = [5,10,15,30]            # 행동 공간을 선언
    ...
    def get_features_Test(self, track_id, state_histories: list[np.ndarray]):
        ...
        for state_history in state_histories:
            ...
            state_history = state_history[::-1]  # 최신 → 과거
