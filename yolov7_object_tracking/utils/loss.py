...
from yolov7_object_tracking.utils.general import bbox_iou, bbox_alpha_iou, box_iou, box_giou, box_diou, box_ciou, xywh2xyxy
from yolov7_object_tracking.utils.torch_utils import is_parallel
