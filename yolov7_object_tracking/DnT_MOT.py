...
def detect_frame(model, device, half, opt: Options, source=None, gt_folder=None, sort_tracker =None, frame_rate =60):
    ...
    with torch.no_grad():
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                object_num = dets_to_sort.shape[0]
        ...
        del img, dataset
        return tracked_dets, tracks, sort_tracker
